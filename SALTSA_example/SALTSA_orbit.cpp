...
#if (1)
// SALTSA::interpolator_functor class method implementations
#if (1)
...
// Constructors
SALTSA::interpolator_functor::interpolator_functor()
{
...
SALTSA::interpolator_functor::interpolator_functor(
		const SALTSA::interpolator *init_interpolator_ptr )
{
	set_interpolator_ptr( init_interpolator_ptr );
}

// Operator=
SALTSA::interpolator_functor & SALTSA::interpolator_functor::operator=(
		SALTSA::interpolator_functor other)
{
    swap(other);
...
// Set functions
const int SALTSA::interpolator_functor::set_interpolator_ptr(
		const SALTSA::interpolator *new_spline_ptr )
{
...
// Function method
const int SALTSA::interpolator_functor::operator()( const double & in_param,
...
// SALTSA::interpolator_derivative_functor class method implementations
#if (1)

// Swap functions
void SALTSA::interpolator_derivative_functor::swap(
...
// Constructors
SALTSA::interpolator_derivative_functor::interpolator_derivative_functor()
{
...
// Operator=
SALTSA::interpolator_derivative_functor& SALTSA::interpolator_derivative_functor::operator=(
		SALTSA::interpolator_derivative_functor other)
{
	swap(other);
	return *this;
...
// Set functions
const int SALTSA::interpolator_derivative_functor::set_interpolator_ptr(
		const SALTSA::interpolator *new_interpolator_ptr )
{
...
// Function method
const int SALTSA::interpolator_derivative_functor::operator()(
...
// SALTSA::interpolator_derivative_weight_functor class method implementations
#if (1)
// Swap functions
void SALTSA::interpolator_derivative_weight_functor::swap(
...
// Constructors
SALTSA::interpolator_derivative_weight_functor::interpolator_derivative_weight_functor()
{
	_sample_scale_ = 0;
...
// Operator=
SALTSA::interpolator_derivative_weight_functor &
	SALTSA::interpolator_derivative_weight_functor::operator=(
			SALTSA::interpolator_derivative_weight_functor other)
{
	swap(other);
	return *this;
...
// Set functions
const int SALTSA::interpolator_derivative_weight_functor::set_sample_scale(
...
const int SALTSA::interpolator_derivative_weight_functor::set_sample_max_width(
...
const int SALTSA::interpolator_derivative_weight_functor::set_center_point(
...
const int SALTSA::interpolator_derivative_weight_functor::set_t_min(
		double new_t_min )
{
	_t_min_ = new_t_min;
	return 0;
...
const int SALTSA::interpolator_derivative_weight_functor::set_t_max(
		double new_t_max )
{
	_t_max_ = new_t_max;
	return 0;
...
// Function method
const int SALTSA::interpolator_derivative_weight_functor::operator()(
		const double & in_param,
		double & out_param, const bool silent ) const
{
...
// SALTSA::interpolator_derivative class method implementations
#if (1)

// Swap functions
void SALTSA::interpolator_derivative::swap(interpolator_derivative &other)
{
	using std::swap;
...
SALTSA::interpolator_derivative::interpolator_derivative( const interpolator_derivative &other )
{
...
// Operator=
SALTSA::interpolator_derivative & SALTSA::interpolator_derivative::operator=(
...
// Swap functions
void SALTSA::stripping_orbit::swap(stripping_orbit &other)
{
	using std::swap;
		...
		const stripping_orbit &other )
{
	...
	else
	{
		...
		std::vector< SALTSA::stripping_orbit_segment >::iterator test_iterator_old = other._orbit_segments_.begin();
...
// Swap functions
void SALTSA::stripping_orbit_segment::swap(stripping_orbit_segment &other)
{
	using std::swap;
...
// SALTSA::solve_rt_sd_functor class method implementations
#if (1)

const int SALTSA::solve_rt_grid_functor::operator()(
		const double & in_param,
		double & out_param, const bool silent ) const
{
	double r;
...
SALTSA::solve_rt_grid_functor::solve_rt_grid_functor()
{
	omega = 0;
	Daccel = 0;
	sum_delta_rho = 0;
...
const int SALTSA::solve_rt_it_functor::operator()(
		const double & in_param,
		double & out_param, const bool silent ) const
{
	double r = 0;
...
SALTSA::solve_rt_it_functor::solve_rt_it_functor()
{
	omega = 0;
	satellite_ptr = NULL;
	Daccel = 0;
...
#endif // end SALTSA::solve_rt_sd_functor class function definitions

// SALTSA::gabdt class method implementations
#if (1)

// Swap functions
void SALTSA::gabdt::swap(gabdt &other)
{
	using std::swap;
...
SALTSA::gabdt::gabdt( const gabdt & other )
{
...
SALTSA::gabdt & SALTSA::gabdt::operator=( gabdt other )
{
	swap(other);
	return *this;
}
...
// SALTSA::gabdt_functor class method implementations
#if (1)

// Swap functions
void SALTSA::gabdt_functor::swap(gabdt_functor &other)
{
	using std::swap;
...
// Constructors
SALTSA::gabdt_functor::gabdt_functor()
{
	host_ptr = NULL;
}
SALTSA::gabdt_functor::gabdt_functor(const gabdt_functor &other)
{
	host_ptr = other.host_ptr;
}

// Operator=
SALTSA::gabdt_functor & SALTSA::gabdt_functor::operator=(gabdt_functor other)
{
	swap(other);
	return *this;
}
...
// Operator()
const int SALTSA::gabdt_functor::operator()(
...
#endif // end SALTSA::gabdt_functor class function definitions
