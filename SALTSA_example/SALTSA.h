...
/***********************************************************************\
 stripping_orbit: This is the primary class used for calculating tidal
 stripping.

 This class stores a number of points representing a  satellite's
 position and velocity relative to its host halo at various times.
...
private:
	...
	/// Default interpolation method. Implemented in SALTSA_orbit.cpp.
	...
	double _t_min_override_value_, _t_max_override_value_;
	//@}
	...
	const int _pass_parameters_to_segment(
			...
			SALTSA::density_profile *segment_init_satellite=NULL,
			SALTSA::density_profile *segment_init_host=NULL,
...
public:
	...
	const std::vector< std::pair< double, std::vector< double > > > & host_parameter_spline_points() const
