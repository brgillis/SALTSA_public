...
#if (1)
// Initialisation for SALTSA::grid_cache
#if (1)
...
#endif // End initialisation for SALTSA::grid_cache

// Initialisation for SALTSA::dfa_cache
DEFINE_BRG_CACHE_STATIC_VARS( dfa_cache, 0, 5, 0.01 );

// Initialisation for SALTSA::add_cache
#if (1)
bool SALTSA::add_cache::loaded = false;
std::string SALTSA::add_cache::file_name = "SALTSA_add_cache.dat";
double SALTSA::add_cache::z_min = 0; // These values will only be used if the cache needs to be created and they aren't overridden
double SALTSA::add_cache::z_max = 5;
double SALTSA::add_cache::z_step = 0.01;
int SALTSA::add_cache::z_res = (int)( ( add_cache::z_max - add_cache::z_min )
		/ add_cache::z_step ) + 1;
std::string SALTSA::add_cache::header_string = "# ADD cache v1.0";
int SALTSA::add_cache::sig_digits = 8;
std::vector< std::vector< double > > SALTSA::add_cache::dmod;
#endif // End initialization for SALTSA::add_cache

// Initialisation for SALTSA::tfa_cache
DEFINE_BRG_CACHE_STATIC_VARS( tfa_cache, 0.001, 1.02, 0.001 );

// Initialisation for SALTSA::tNFW_sig_cache
#if (1)
bool SALTSA::tNFW_sig_cache::loaded = false;
std::string SALTSA::tNFW_sig_cache::file_name = "SALTSA_NFW_sig_cache.dat";
double SALTSA::tNFW_sig_cache::halo_z_min = 0.1; // These values will only be used if the cache needs to be created and they aren't overridden
double SALTSA::tNFW_sig_cache::halo_z_max = 1.3;
double SALTSA::tNFW_sig_cache::halo_z_step = 0.1;
int SALTSA::tNFW_sig_cache::halo_z_res = (int)( ( tNFW_sig_cache::halo_z_max
		- tNFW_sig_cache::halo_z_min ) / tNFW_sig_cache::halo_z_step ) + 1;
double SALTSA::tNFW_sig_cache::halo_m_min = 10;
double SALTSA::tNFW_sig_cache::halo_m_max = 16;
double SALTSA::tNFW_sig_cache::halo_m_step = 0.01;
int SALTSA::tNFW_sig_cache::halo_m_res = (int)( ( tNFW_sig_cache::halo_m_max
		- tNFW_sig_cache::halo_m_min ) / tNFW_sig_cache::halo_m_step ) + 1;
double SALTSA::tNFW_sig_cache::r_min = 1 * unitconv::kpctom;
double SALTSA::tNFW_sig_cache::r_max = 5000 * unitconv::kpctom;
double SALTSA::tNFW_sig_cache::r_step = 1 * unitconv::kpctom;
int SALTSA::tNFW_sig_cache::r_res = (int)( ( r_max - r_min ) / r_step ) + 1;
std::string SALTSA::tNFW_sig_cache::header_string = "# NFW_sig v1.0";
int SALTSA::tNFW_sig_cache::sig_digits = 8;
std::vector< std::vector< std::vector< double > > > SALTSA::tNFW_sig_cache::signal;
#endif // End initialization for SALTSA::tNFW_sig_cache

// Initialization for SALTSA::tNFW_offset_sig_cache
#if (1)
bool SALTSA::tNFW_offset_sig_cache::loaded = false;
std::string SALTSA::tNFW_offset_sig_cache::file_name =
		"SALTSA_NFW_offset_sig_cache.dat";
double SALTSA::tNFW_offset_sig_cache::halo_z_min = 0.1; // These values will only be used if the cache needs to be created and they aren't overridden
double SALTSA::tNFW_offset_sig_cache::halo_z_max = 1.3;
double SALTSA::tNFW_offset_sig_cache::halo_z_step = 0.1;
int SALTSA::tNFW_offset_sig_cache::halo_z_res =
		(int)( ( tNFW_offset_sig_cache::halo_z_max
				- tNFW_offset_sig_cache::halo_z_min )
				/ tNFW_offset_sig_cache::halo_z_step ) + 1;
double SALTSA::tNFW_offset_sig_cache::halo_m_min = 10;
double SALTSA::tNFW_offset_sig_cache::halo_m_max = 16;
double SALTSA::tNFW_offset_sig_cache::halo_m_step = 0.01;
int SALTSA::tNFW_offset_sig_cache::halo_m_res =
		(int)( ( tNFW_offset_sig_cache::halo_m_max
				- tNFW_offset_sig_cache::halo_m_min )
				/ tNFW_offset_sig_cache::halo_m_step ) + 1;
double SALTSA::tNFW_offset_sig_cache::r_min = 1 * unitconv::kpctom;
double SALTSA::tNFW_offset_sig_cache::r_max = 5000 * unitconv::kpctom;
double SALTSA::tNFW_offset_sig_cache::r_step = 1 * unitconv::kpctom;
int SALTSA::tNFW_offset_sig_cache::r_res =
		(int)( ( tNFW_offset_sig_cache::r_max - tNFW_offset_sig_cache::r_min )
				/ tNFW_offset_sig_cache::r_step ) + 1;
double SALTSA::tNFW_offset_sig_cache::offset_r_min = -1;
double SALTSA::tNFW_offset_sig_cache::offset_r_max = 4;
double SALTSA::tNFW_offset_sig_cache::offset_r_step = 0.1;
int SALTSA::tNFW_offset_sig_cache::offset_r_res =
		(int)( ( tNFW_offset_sig_cache::offset_r_max
				- tNFW_offset_sig_cache::offset_r_min )
				/ tNFW_offset_sig_cache::offset_r_step ) + 1;
std::string SALTSA::tNFW_offset_sig_cache::header_string =
		"# NFW_offset_sig v1.0";
int SALTSA::tNFW_offset_sig_cache::sig_digits = 8;
std::vector< std::vector< std::vector< std::vector< double > > > > SALTSA::tNFW_offset_sig_cache::signal;
#endif // End initialization for SALTSA::tNFW_offset_sig_cache

// Initialization for SALTSA::tNFW_group_sig_cache
#if (1)
bool SALTSA::tNFW_group_sig_cache::loaded = false;
std::string SALTSA::tNFW_group_sig_cache::file_name =
		"SALTSA::tNFW_group_sig_cache.dat";
double SALTSA::tNFW_group_sig_cache::halo_z_min = 0.1; // These values will only be used if the cache needs to be created and they aren't overridden
double SALTSA::tNFW_group_sig_cache::halo_z_max = 1.3;
double SALTSA::tNFW_group_sig_cache::halo_z_step = 0.1;
int SALTSA::tNFW_group_sig_cache::halo_z_res =
		(int)( ( tNFW_group_sig_cache::halo_z_max
				- tNFW_group_sig_cache::halo_z_min )
				/ tNFW_group_sig_cache::halo_z_step ) + 1;
double SALTSA::tNFW_group_sig_cache::halo_m_min = 10;
double SALTSA::tNFW_group_sig_cache::halo_m_max = 16;
double SALTSA::tNFW_group_sig_cache::halo_m_step = 0.01;
int SALTSA::tNFW_group_sig_cache::halo_m_res =
		(int)( ( tNFW_group_sig_cache::halo_m_max
				- tNFW_group_sig_cache::halo_m_min )
				/ tNFW_group_sig_cache::halo_m_step ) + 1;
double SALTSA::tNFW_group_sig_cache::r_min = 1 * unitconv::kpctom;
double SALTSA::tNFW_group_sig_cache::r_max = 5000 * unitconv::kpctom;
double SALTSA::tNFW_group_sig_cache::r_step = 1 * unitconv::kpctom;
int SALTSA::tNFW_group_sig_cache::r_res =
		(int)( ( tNFW_group_sig_cache::r_max - tNFW_group_sig_cache::r_min )
				/ tNFW_group_sig_cache::r_step ) + 1;
double SALTSA::tNFW_group_sig_cache::group_c_min = 2;
double SALTSA::tNFW_group_sig_cache::group_c_max = 8;
double SALTSA::tNFW_group_sig_cache::group_c_step = 1;
int SALTSA::tNFW_group_sig_cache::group_c_res =
		(int)( ( tNFW_group_sig_cache::group_c_max
				- tNFW_group_sig_cache::group_c_min )
				/ tNFW_group_sig_cache::group_c_step ) + 1;
std::string SALTSA::tNFW_group_sig_cache::header_string =
		"# NFW_group_sig v1.0";
int SALTSA::tNFW_group_sig_cache::sig_digits = 8;
std::vector< std::vector< std::vector< std::vector< double > > > > SALTSA::tNFW_group_sig_cache::signal;
#endif // End initialization for SALTSA::tNFW_group_sig_cache
...
#if (1)
const int SALTSA::redshift_obj::z_grid() const
{
	if ( _z_grid_cached_ )
	{
...
const int SALTSA::sky_obj::clear()
{
	set_ra_dec_z_err( 0, 0, 0, 0, 0, 0 );
	return partial_clear();
}

const int SALTSA::sky_obj::partial_clear()
{
	_index_ = 0;
	_ID_ = "0";
	_weight_ = 1;
...
const int SALTSA::sky_obj::set_weight( const double new_weight )
{
	_weight_ = new_weight;
	return 0;
}
const int SALTSA::sky_obj::set_index( const int new_index )
{
	_index_ = new_index;
	return 0;
}
const int SALTSA::sky_obj::set_ID( const std::string &new_ID )
{
	_ID_ = new_ID;
	return 0;
}

const int SALTSA::sky_obj::ra_grid() const
{
	if ( _ra_grid_cached_ )
	{
...
const int SALTSA::sky_obj::dec_grid() const
{
	...
	_dec_grid_ = SALTSA::get_dec_grid( dec() );
	_dec_grid_cached_ = true;
	_local_dec_grid_change_num_ = grid_cache().dec_grid_change_num();
	return _dec_grid_;
}

#endif // end SALTSA::sky_obj class functions

// SALTSA::galaxy class methods
#if (1)
SALTSA::galaxy::galaxy()
{
...
#endif // end SALTSA::galaxy class functions

// SALTSA::group class methods
#if (1)

// Constructor
SALTSA::group::group( int init_num_members )
{
...
// Copy constructor
SALTSA::group::group( const group &other_group ) :
		sky_obj( other_group )
{
...
// Other functions
const int SALTSA::group::clear()
{
	group();
	return 0;
}

const int SALTSA::group::resize( int new_num_members )
{
...
const int SALTSA::group::set_member( int member_index, galaxy * new_member,
		const bool silent )
{
...
const int SALTSA::group::set_member_index( int member_index,
...
const int SALTSA::group::add_member( galaxy * new_member, const bool silent )
{
...
const int SALTSA::group::remove_member( galaxy * rem_member,
		const bool silent )
{
	int i;
...
#endif // End SALTSA::group class functions
		...
		const bool silent ) const
{
	...
	if ( R_to_use == 0 )
	{
		...
		if ( SALTSA::integrate( &func, num_in_params, min_in_params,
		...
		const double &offset_R, const bool silent ) const
{
	...
	if ( SALTSA::integrate_Rhomberg( &ringfunc, 1, min_in_params_ring,
	...
	if ( SALTSA::integrate_Rhomberg( &circfunc, 2, min_in_params_circ,
...
// SALTSA::dfa_cache class methods
#if (1)
const int SALTSA::dfa_cache::_calculate( const double in_params, double & out_params ) const
{
	try
	{
		out_params = SALTSA::integrate_add( 0, in_params );
	}
...
#endif // end SALTSA::dfa_cache functions

// SALTSA::add_cache class methods
#if (1)

const int SALTSA::add_cache::load( const bool silent )
{
	...
	do
	{
		if ( loop_counter >= 2 )
		{
			if ( !silent )
				std::cerr
						<< "ERROR: infinite loop detected in SALTSA::add_cache.\n";
...
const int SALTSA::add_cache::unload()
{
	loaded = false;
	return del_array2d( dmod, z_res );
}

const int SALTSA::add_cache::calc( const bool silent )
{
	int i = 0, j = 0;
	...
	for ( double z1 = z_min; z1 < z_max; z1 += z_step )
	{
		...
		{
			dmod[i][j] = SALTSA::integrate_add( z1, z2 );
			j++;
		}
		j = 0;
		i++;
...
const int SALTSA::add_cache::output( const bool silent )
{
...
const int SALTSA::add_cache::set_file_name( const std::string new_name )
{
	file_name = new_name;
	if ( loaded )
	{
...
const int SALTSA::add_cache::set_range( const double new_z_min,
...
const int SALTSA::add_cache::set_precision( const int new_precision,
		const bool silent )
{
	if ( new_precision > 0 )
	{
...
#endif // end SALTSA::add_cache functions
...
// SALTSA::tNFW_sig_cache class methods
#if (1)

const int SALTSA::tNFW_sig_cache::load( const bool silent )
{
	std::ifstream in_file;
	std::string file_data;
	bool need_to_calc = false;
	...
	do
	{
		if ( loop_counter >= 2 )
		{
			if ( !silent )
				std::cerr
						<< "ERROR: infinite loop detected in SALTSA::tNFW_sig_cache.\n";
			return INFINITE_LOOP_ERROR;
		}
		else
		{
...
const int SALTSA::tNFW_sig_cache::unload()
{
	loaded = false;
	return del_array3d( signal, halo_z_res, halo_m_res );
}

const int SALTSA::tNFW_sig_cache::calc( const bool silent )
{
	int i, j, k;
	...
	for ( double z = halo_z_min; z < halo_z_max; z += halo_z_step )
	{
		for ( double m = halo_m_min; m < halo_m_max; m += halo_m_step )
		{
			...
			conc = SALTSA::cfm( mass, z );
			tau = default_tau_factor * conc;
			for ( double r = r_min; r < r_max; r += r_step )
			{

				signal[i][j][k] =
						SALTSA::tNFW_profile( mass, z, conc, tau ).deltasigma(
								r );
				k++;
			}
			k = 0;
...
const int SALTSA::tNFW_sig_cache::output( const bool silent )
{
	std::ofstream out_file;
	std::string file_data;
...
const int SALTSA::tNFW_sig_cache::set_file_name( const std::string new_name )
{
	file_name = new_name;
	if ( loaded )
	{
...
const int SALTSA::tNFW_sig_cache::set_range( const double new_halo_z_min,
...
const int SALTSA::tNFW_sig_cache::set_precision( const int new_precision,
		const bool silent )
{
	if ( new_precision > 0 )
	{
...
#endif // end SALTSA::tNFW_sig_cache functions

// SALTSA::NFW_offset_sig_cache class methods
#if (1)

const int SALTSA::tNFW_offset_sig_cache::load( const bool silent )
{
	std::ifstream in_file;
	std::string file_data;
	bool need_to_calc = false;
	...
	do
	{
		if ( loop_counter >= 2 )
		{
			if ( !silent )
				std::cerr
						<< "ERROR: infinite loop detected in SALTSA::NFW_offset_sig_cache.\n";
			return INFINITE_LOOP_ERROR;
		}
		else
		{
...
const int SALTSA::tNFW_offset_sig_cache::unload()
{
	loaded = false;
	return del_array4d( signal, halo_z_res, halo_m_res, r_res );
}

const int SALTSA::tNFW_offset_sig_cache::calc( const bool silent )
{
		...
		for ( int j = 0; j < halo_m_res; j++ )
		{
			...
			for ( int k = 0; k < r_res; k++ )
			{
				...
				for ( int l = 0; l < offset_r_res; l++ )
				{
					...
					signal[i][j][k][l] = SALTSA::tNFW_profile( mass, z, conc,
...
const int SALTSA::tNFW_offset_sig_cache::output( const bool silent )
{
	std::ofstream out_file;
	std::string file_data;
...
const int SALTSA::tNFW_offset_sig_cache::set_file_name(
...
const int SALTSA::tNFW_offset_sig_cache::set_range(
...
const int SALTSA::tNFW_offset_sig_cache::set_precision(
...
#endif // end SALTSA::NFW_offset_sig_cache functions

// SALTSA::tNFW_group_sig_cache class methods
#if (1)

const int SALTSA::tNFW_group_sig_cache::load( const bool silent )
{
	std::ifstream in_file;
	std::string file_data;
	bool need_to_calc = false;
...
const int SALTSA::tNFW_group_sig_cache::unload()
{
	loaded = false;
	return del_array4d( signal, halo_z_res, halo_m_res, r_res );
}

const int SALTSA::tNFW_group_sig_cache::calc( const bool silent )
{
		...
		for ( int j = 0; j < halo_m_res; j++ )
		{
			...
			for ( int k = 0; k < r_res; k++ )
			{
				...
				for ( int l = 0; l < group_c_res; l++ )
				{
					...
					signal[i][j][k][l] =
							SALTSA::tNFW_profile( mass, z ).group_WLsig( r,
									group_c );
...
const int SALTSA::tNFW_group_sig_cache::output( const bool silent )
{
	std::ofstream out_file;
	std::string file_data;
...
const int SALTSA::tNFW_group_sig_cache::set_file_name(
		const std::string new_name )
{
	file_name = new_name;
	if ( loaded )
...
const int SALTSA::tNFW_group_sig_cache::set_range(
		const double new_halo_z_min, const double new_halo_z_max,
		const double new_halo_z_step, const double new_halo_m_min,
		const double new_halo_m_max, const double new_halo_m_step,
		const double new_r_min, const double new_r_max,
...
const int SALTSA::tNFW_group_sig_cache::set_precision(
		const int new_precision, const bool silent )
{
	if ( new_precision > 0 )
	{
...
#endif // end SALTSA::tNFW_group_sig_cache functions
...
// SALTSA::projected_density_function class methods
#if (1)

const int SALTSA::projected_density_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
#endif // end SALTSA::projected_density_function class methods

// SALTSA::cylindrical_density_function class methods
#if (1)

const int SALTSA::cylindrical_density_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
SALTSA::cylindrical_density_function::cylindrical_density_function()
{
	_host_ptr_ = 0;
}
SALTSA::cylindrical_density_function::cylindrical_density_function(
...
#endif // end SALTSA::cylindrical_density_function class methods
...
// SALTSA::offset_ring_dens_function class methods
#if (1)
...
const int SALTSA::offset_ring_dens_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
// SALTSA::offset_circ_dens_function class methods
#if (1)
...
const int SALTSA::offset_circ_dens_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
#endif // end SALTSA::offset_circ_dens_function function implementations
...
const int SALTSA::offset_WLsig_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
// SALTSA::offset_WLsig_weight_function class methods
#if (1)

const int SALTSA::offset_WLsig_weight_function::set_c( const double new_c )
{
	_c_ = new_c;
	return 0;
}
		...
		double & out_param, const bool silent ) const
{
	...
	{
		BRG_UNIQUE_PTR<SALTSA::density_profile> group_profile(_host_ptr_->density_profile_clone());
...
const int SALTSA::offset_WLsig_weight_function::set_host_ptr(
		const density_profile *new_host )
{
	_host_ptr_ = new_host;
	return 0;
...
SALTSA::offset_WLsig_weight_function::offset_WLsig_weight_function()
{
	_host_ptr_ = 0;
	_c_ = 0;
}
...
const int SALTSA::get_z_grid( const double z )
{
	grid_cache cache;
...
const double SALTSA::get_z_grid_lower( const int z_grid )
{
	grid_cache cache;
...
const double SALTSA::get_z_grid_upper( const int z_grid )
{
	grid_cache cache;
...
const double SALTSA::get_z_grid_mid( const int z_grid )
{
	grid_cache cache;
...
#if (1)
const double SALTSA::integrate_add( const double z1, const double z2 )
{
	return SALTSA::integrate_distance( z1, z2, 0 );
}
...
const double SALTSA::integrate_add( const double z )
{
	return SALTSA::integrate_distance( 0, z, 0 );
}
		...
		const double z_source )
{
	return pow( c, 2 ) / ( 4. * pi * Gc )
			* SALTSA::ad_distance( 0, z_source )
			/ ( SALTSA::ad_distance( 0, z_lens )
					* SALTSA::ad_distance( z_lens, z_source ) );
